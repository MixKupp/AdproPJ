...
import se233.projectadpro.model.imagederivatives.ConvolutionKernel;
import se233.projectadpro.model.imagederivatives.ImageConvolution;
import se233.projectadpro.model.util.*;
...
//      CannyEdgeDetector canny = new Builder(pixels)
//                                                     .minEdgeSize(10)
//                                                     .thresholds(15, 35)
//                                                     .L1norm(false)
//                                                     .build();
